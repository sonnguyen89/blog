				...
				<div class="slide slide-<?php echo $count; ?>" <?php if($woo_options[ 'woo_slider_entries' ] == 1) { echo 'style="display:block;"'; }?>>
	    			...
	    			<div class="image">
	    				...
	    				<?php if ($woo_options[ 'woo_slider_autoheight' ] == "true") { ?>
	    					<?php woo_image('key=image&width=620&class=slide-img&link=img&meta=' . get_the_title() . ''); ?>
						<?php } else { ?>
							<?php woo_image('key=image&width=620&height=' .$woo_options['woo_slider_fixed_height']. '&class=slide-img&link=img&meta=' . get_the_title() . ''); ?>
						<?php } ?>
